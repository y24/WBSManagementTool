...
def seed_data():
    ...
    try:
        # Seed statuses
        statuses = [
            {"id": 1, "status_name": "New", "color_code": "#818CF8", "sort_order": 1, "is_active": True},
            {"id": 2, "status_name": "In Progress", "color_code": "#34D399", "sort_order": 2, "is_active": True},
            {"id": 3, "status_name": "In Review", "color_code": "#FBBF24", "sort_order": 3, "is_active": True},
            {"id": 4, "status_name": "Done", "color_code": "#9CA3AF", "sort_order": 4, "is_active": True},
            {"id": 5, "status_name": "Blocked", "color_code": "#F87171", "sort_order": 5, "is_active": True},
            {"id": 6, "status_name": "Pending", "color_code": "#A78BFA", "sort_order": 6, "is_active": True},
