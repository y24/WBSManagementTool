...
class MstSubtaskType(Base):
    ...
    azure_devops_work_item_type = Column(String(100), nullable=True)
...
class MstStatus(Base):
    ...
    azure_devops_sync_ticket_id = Column(Boolean, nullable=False, default=True)
    azure_devops_sync_testing_id = Column(Boolean, nullable=False, default=True)
    sort_order = Column(Integer, nullable=False, default=0)
    is_active = Column(Boolean, nullable=False, default=True)
...
class Project(Base):
    ...
    is_auto_planned_date = Column(Boolean, nullable=False, default=True)
