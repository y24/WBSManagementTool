    ...
    <div className="sticky top-0 z-30 flex border-b border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 shadow-sm whitespace-nowrap h-[38px] transition-colors">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex h-[18px] border-b border-slate-200/50 dark:border-slate-700/50 select-none">
          {!hidePlanningColumns && (
            <div 
              className="flex-shrink-0 flex items-center justify-start pl-2 text-[9px] font-bold text-blue-600/80 dark:text-blue-400/80 bg-blue-100/50 dark:bg-blue-900/30 border-r border-slate-200 dark:border-slate-700 uppercase tracking-tighter"
              style={{ width: showManHours ? 464 : 400 }}
            >
              計画
            </div>
          )}
          {!isPlanningMode && (
            <div 
              className="flex-shrink-0 flex items-center justify-start pl-2 text-[9px] font-bold text-emerald-600/80 dark:text-emerald-400/80 bg-emerald-100/50 dark:bg-emerald-900/30 border-r border-slate-200 dark:border-slate-700 uppercase tracking-tighter"
              style={{ width: showManHours ? 304 : 240 }}
            >
              実績
            </div>
          )}
