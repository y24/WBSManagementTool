    ...
    >
      <div className="sticky top-0 z-20 flex bg-slate-50 dark:bg-slate-900 text-xs font-semibold text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-700 shadow-sm min-h-[42px] min-w-max">
        ...
        <div className="flex w-full py-1 items-center">
          <div className="sticky left-0 z-30 bg-slate-50 dark:bg-slate-900 min-w-[140px] pl-2 pr-4 py-2 flex-1 truncate">担当者名</div>
        ...
        {data.map((row) => (
          ...
          >
            <div className="flex w-full py-1 items-center h-full">
              <div className="sticky left-0 z-10 bg-white dark:bg-slate-900 group-hover/row:bg-slate-50 dark:group-hover/row:bg-slate-800/50 min-w-[140px] pl-2 pr-4 truncate font-medium text-sm text-slate-800 dark:text-slate-200 h-full flex items-center flex-1">
